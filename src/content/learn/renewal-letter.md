...
Renewal is also a cheap time to fix things: shorten or lengthen the amortization, add prepayment room, consolidate a debt, or add a line of credit. None of these carry a penalty at renewal. Run the [renewal calculator](/calculators/renewal) with your letter's rate, then [set a reminder](/calculators/renewal-reminder) so we contact you before the next one.
