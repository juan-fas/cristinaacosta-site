...
verified: 2026-09-16
tool: "/calculators/self-employed"
situation: "/mortgages/self-employed"
sources: []
verify:
  - "Add-back items accepted by the main insurers"
---
...
Talk to us before your year end, not after. Sometimes a mortgage is easier three months after filing than three months before, and a small change in how expenses are claimed can change the outcome. Try the [income estimator](/calculators/self-employed) for a first look, then [talk to Juan](/start?for=self).
